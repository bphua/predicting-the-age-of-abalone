...
The data is provided by the Machine Leanring Repository at University of California Irvince. It was orginally obtained from the Department of Primary Industry and Fisheries, Tasmania. The variables are:
\begin{table}[]
\begin{tabular}{llll}
...
The data contains no missing values. 2 outliers were noticed for Height and removed. We also removed any instanced where the sum of the constituent weights was larger than the Whole_weight. 
